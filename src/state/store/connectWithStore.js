 ...
 * and the store coming from the Provider not reaching child components. We will
 * stay on redux version 5.1.1 until a fix is found, as redux does not allow passing
 * in the store directly after version 6.
 *
